...
import com.sharpwisdom.third.multipleInputs.FlagStringDataType;
import com.sharpwisdom.third.multipleInputs.MultipleInputsMapper01;
import com.sharpwisdom.third.multipleInputs.MultipleInputsMapper02;
import com.sharpwisdom.third.multipleInputs.MultipleInputsReducer;
...
public class JobMain extends Configuration implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        job.setReducerClass(MultipleInputs02Reducer.class);
        job.setOutputKeyClass(Text.class);
        job.setOutputValueClass(Text.class);

        MultipleInputs.addInputPath(job, new Path(input1), FirstInputFormat.class, FirstMultipleInputs02Mapper.class);
        MultipleInputs.addInputPath(job,new Path(input2), SecondInputFormat.class,SecondMultipleInputs02Mapper.class);
